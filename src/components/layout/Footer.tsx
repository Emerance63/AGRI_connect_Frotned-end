        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-2">
                <input
                  ...
                  className="flex-1 rounded-lg border border-border bg-surface px-3 py-2 text-sm text-ink placeholder:text-ink-muted focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20"
                  required
                />
                <button
                  type="submit"
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="rounded-full bg-brand-100 px-3 py-1 text-xs font-medium text-brand-700">NAEB</span>
                <span className="rounded-full bg-brand-100 px-3 py-1 text-xs font-medium text-brand-700">RAB</span>
                <span className="rounded-full bg-brand-100 px-3 py-1 text-xs font-medium text-brand-700">Fair Trade</span>
                <span className="rounded-full bg-brand-100 px-3 py-1 text-xs font-medium text-brand-700">ISO 22000</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/dashboard" className="text-sm text-ink-muted hover:text-brand-600 transition-colors">
                  Cooperative Dashboard
                </Link>
              </li>
              <li>
                <Link href="/login" className="text-sm text-ink-muted hover:text-brand-600 transition-colors">
                  Cooperative Login
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h3 className="text-sm font-semibold text-ink mb-4">Legal & Quality</h3>
            <ul className="space-y-3">
              <li>
                <Link href="#" className="text-sm text-ink-muted hover:text-brand-600 transition-colors">
                  Quality Standards
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            <div>
              ...
              <a href="mailto:info@agriconnect.rw" className="text-sm text-ink-muted hover:text-brand-600 transition-colors">
                info@agriconnect.rw
              </a>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a href="#" className="flex h-8 w-8 items-center justify-center rounded-full bg-surface text-ink-muted hover:bg-brand-600 hover:text-white transition-colors">
          ...
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="rounded-lg border border-border bg-surface px-3 py-1.5 text-sm text-ink focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20"
              >
