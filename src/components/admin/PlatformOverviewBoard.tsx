...
const navItems = [
  { icon: LayoutGrid, label: "Platform Overview", active: true },
  { icon: Users, label: "Users & Buyers" },
  { icon: ShieldCheck, label: "Verification (RCA)" },
...
export default function AgriConnectDashboard() {
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 text-sm">
      ...
      <div className="flex">
        {/* Sidebar */}
        <div className="w-56 shrink-0 border-r border-zinc-900 bg-zinc-950 p-3.5 flex flex-col">
          <div className="flex items-center gap-2.5 px-1.5 pb-5">
            ...
            <div>
              <div className="font-semibold text-[14px]">AgriConnect</div>
            ...
            {navItems.map(({ icon: Icon, label }) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-[13.5px] text-left transition-colors ${
                    isActive
          ...
          <div className="mt-auto pt-3.5 border-t border-zinc-900">
            ...
            <button className="flex items-center gap-1.5 text-xs text-zinc-400 px-1.5 pt-2.5 hover:text-white">
              <LogOut size={13} />
              Switch to Cooperative view
            </button>
          </div>
        </div>
