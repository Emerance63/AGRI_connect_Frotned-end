...
const rw: Translations = {
  ...
  dashboard: {
    ...
    trendInStock: "Iboneka mu bubiko",
    trendPending: "bitegereje",
    trendUpdatedFromBuyers: "Ivuye ku baguzi",
    trendScheduled: "iteganijwe",
  ...
  productNames: {
    ...
    "White Rice": "Umuceli Muzuru",
    "Green Cabbage": "Amashu Atoto",
